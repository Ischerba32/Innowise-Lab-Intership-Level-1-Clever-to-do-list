    ...
    <div className={styles.spinnerContainer}>
      <div className={styles.spinnerContainer__spinner}>
        <svg width="100%" viewBox="0 0 248 247" fill="none" xmlns="http://www.w3.org/2000/svg"  >
          <g id="spinner2">
            <g className={styles.spinnerContainer__spinner_outer} style={{animationDuration:speed+"s"}}>
            ...
            <g className={styles.spinnerContainer__spinner_inner} style={{animationDuration:speed+"s"}}>
